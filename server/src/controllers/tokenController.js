...
module.exports = {
  ...
  async testeToken(req, res) {
    ...
    const tokenData = await Token.findById('61671c75948d5e736bdbdc6e')
    // console.log(tokenData)
    // id: 4893681057327807
    // const tokenData = await Token.findOne({ userId: userId })
    if (tokenData) {
      // const responseProfileData = await get("https://api.instagram.com/v1/users/search?q=buscafeed&client_id=261340495802382", {
      // const responseProfileData = await get("https://graph.instagram.com/v12.0/4893681057327807", {
      const responseProfileData = await get("https://www.instagram.com/buscafeed/?__a=1", {
      // // const responseProfileData = await get("https://graph.facebook.com/v10.0/176631627804675", {
      // const responseProfileData = await get("https://graph.facebook.com/v12.0/176631627804675", {
      // const responseProfileData = await get("https://www.instagram.com/p/CTSi8VMP1C9/", {
        // params: {
        //   fields: "id,name",
        //   access_token: "EAAHZBlQieVhcBAOZBHLDZAelRRqVbXLKL04a8Uywz5Kp4eu8kbZCQQUgiuXhmZC1ZA3utqhZBZCl7MDiVFruIfNZCOqESyFdJOM47Bvyptk7tuATAyZCyOQYP0iZBsN1QQON8zPcYL11kgHO19yu7U8qC9ZCm0ZAoECDXQM2lSzaI1Nr7McuthkZC7Xn0NORGaMm7ykOi69I2cP2UtMeO61WIsgRCA",
        // },
        // headers: {
